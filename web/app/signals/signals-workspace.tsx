...
export function SignalsWorkspace({ market }: { market: PlatformMarket }) {
  ...
  return <main className="quant-workspace">
    <WorkspaceHeader
      ...
      title="Live signals"
      description="Completed-candle signals from the unified engine. Blue is a fresh strong buy, orange is holding, green hit its target, red exited or expired. Refreshes every 15 seconds."
