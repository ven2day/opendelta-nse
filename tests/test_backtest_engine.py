...
class MetricsTests(unittest.TestCase):
    def test_drawdown_and_rates_from_streamed_trades(self) -> None:
        ...
        self.assertEqual(public["profitableTrades"], 2)
        self.assertEqual(public["losingTrades"], 2)
        self.assertEqual(public["breakevenTrades"], 0)
        self.assertEqual(public["grossProfit"], 400.0)
        self.assertEqual(public["grossLoss"], 230.0)
        self.assertAlmostEqual(public["profitFactor"], 400.0 / 230.0, places=4)
