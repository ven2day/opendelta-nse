...
from backend.strategies.momentum_scalper_v1 import MomentumScalperV1
...
STRATEGIES.register(MomentumScalperV1())

__all__ = ["MomentumScalperV1", "RsiDipLadderV1", "STRATEGIES", "Strategy", "StrategyRegistry", "StrongBuyV1", "describe_strategy"]
