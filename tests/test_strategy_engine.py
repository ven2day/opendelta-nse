...
class RegistryAndConfigTests(unittest.TestCase):
    def test_strategy_is_discovered_through_the_registry_with_a_settings_schema(self) -> None:
        ...
        self.assertEqual([item.strategy_id for item in STRATEGIES.list("NSE")], ["ema_vwap_strong_buy", "momentum_scalper_v1", "rsi_dip_ladder_v1"])
        self.assertEqual([item.strategy_id for item in STRATEGIES.list("CRYPTO")], ["ema_vwap_strong_buy", "momentum_scalper_v1", "rsi_dip_ladder_v1"])
